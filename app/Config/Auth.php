...
class Auth extends ShieldAuth
{
    ...
    public array $usernameValidationRules = [
        ...
        'rules' => [
            ...
            'max_length[30]',
            'min_length[3]',
            // Add any additional rules as needed for "nama" field
        ],
    ];
    ...
    public array $emailValidationRules = [
        ...
        'rules' => [
            'required',
            'max_length[254]',
            // Add any additional rules as needed for "npm" field
        ],
    ];
...
{
    // Ganti 'smartphone' dengan URI atau nama route dari halaman Smartphone_view.php
    $url = 'Smartphone_view';
